...
public class CadastroCuidadorScreen extends JFrame {
    private JTextField txtNome, txtEmail, txtCelular, txtCpfIdoso;
    ...
    public CadastroCuidadorScreen() {
        ...
        JLabel title = new JLabel("Cadastro Cuidador", SwingConstants.CENTER);
    ...
    private void criarConta() {
        ...
        JOptionPane.showMessageDialog(this, "Cadastro do cuidador realizado com sucesso!");
        dispose();
        new LoginScreen();
    }
}
